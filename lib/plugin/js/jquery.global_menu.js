;(function(factory) {
  ...
  GlobalMenu.prototype.gm_position_fixed = function() {
    ...
    $(window).on('scroll.global_menu.' + _.instance_uid, function(){
      curr_position = $(this).scrollTop();

      _.gm_scroll_fixed_jobs[
        _.settings.scroll_fix.active_y < $(window).scrollTop()?
          'fixed' : 'unfixed'
      ].bind(_)();
  ...
  GlobalMenu.prototype.gm_scroll_fixed_jobs = {
    unfixed : function(){
      let _ = this;

      _.$elem.find('.gm_inner')
        .removeClass('is_fixed is_scroll_up is_scroll_down');
    },
    fixed : function(){
      let _ = this;
  ...
  GlobalMenu.prototype.gm_scroll = {
    up : function(){
      let _ = this;
