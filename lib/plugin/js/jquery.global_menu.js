;(function(factory) {
  ...
  GlobalMenu.prototype.gm_scroll_jobs = {
    unfixed : function(){
      let _ = this;
      ...
      _.$elem.find('.gm_inner')
        .removeClass('is_fixed is_scroll_down is_scroll_up');
    ...
    up : function(){
      ...
      _.$elem.find('.gm_inner')
        .removeClass('is_scroll_down')
        .addClass('is_scroll_up');
    },
    down : function(){
      let _ = this;

      _.$elem.find('.gm_inner')
        .removeClass('is_scroll_up')
        .addClass('is_scroll_down');
    }
  }
